...
import { X, Sparkles, Download, CheckCircle, ShieldCheck, Music } from 'lucide-react';
  ...
  const talismans = [
    {
      ...
      audio: '/audio/CrystalMind_528Hz_Golden_Citrine_15Min_Master.mp3',
      audioLength: '17.0 min',
    ...
    },
    {
      ...
      audio: '/audio/CrystalMind_639Hz_Rose_Quartz_15Min_Master.mp3',
      audioLength: '14.1 min',
    ...
    },
    {
      ...
      audio: '/audio/CrystalMind_741Hz_Amethyst_15Min_Master.mp3',
      audioLength: '11.0 min',
    ...
    },
    {
      ...
      audio: '/audio/CrystalMind_432Hz_Teal_Quartz_15Min_Master.mp3',
      audioLength: '14.3 min',
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-black/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-extrabold text-base md:text-lg text-amber-200">
              Personalized 4K AI Crystal & 15-Min Audio Suite ($4.99 Unlocked)
            </h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 md:p-8 overflow-y-auto space-y-8">
          ...
          <div className="text-center space-y-2 bg-gradient-to-b from-amber-950/40 via-slate-900/80 to-slate-950 p-6 rounded-3xl border border-amber-500/30">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-bold border border-emerald-500/40">
              ...
              PAYMENT VERIFIED • FULL 4K WALLPAPERS + 15-MIN HQ MP3 AUDIO
            </span>
            <h1 className="text-2xl md:text-3xl font-extrabold text-white">
              Congratulations, {customerName}!
            </h1>
            <p className="text-xs md:text-sm text-slate-300 max-w-xl mx-auto leading-relaxed">
              Your personalized 4-Frequency Solfeggio 4K Wallpaper & 15-Minute Master Audio Suite is ready for download.
            </p>
          </div>
            ...
            {talismans.map((item, idx) => (
              ...
              >
                <div className="space-y-2 text-center">
                  ...
                  <div className="relative aspect-[9/16] max-w-[180px] mx-auto rounded-xl overflow-hidden border border-white/20 shadow-2xl">
                    <img
                      src={item.image}
                      alt={item.name}
                ...
                <div className="space-y-2 pt-2">
                  <a
                    ...
                    className="w-full py-2.5 rounded-xl font-bold text-xs bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-400 hover:to-yellow-500 text-black shadow-lg shadow-amber-500/20 flex items-center justify-center gap-1.5 transition-all"
                  >
                  ...
                  <a
                    href={item.audio}
                    download={`CrystalMind_${item.hz}_15Min_Master_Audio.mp3`}
                    className="w-full py-2 rounded-xl font-semibold text-xs bg-white/10 hover:bg-white/20 border border-white/20 text-slate-200 flex items-center justify-center gap-1.5 transition-all"
                  >
                    <Music className="w-3.5 h-3.5 text-amber-400" />
                    Download 15-Min MP3 ({item.audioLength})
                  </a>
                </div>
              </div>
            ))}
          ...
          <div className="bg-black/50 border border-white/10 p-4 rounded-2xl text-center space-y-1.5 text-xs text-slate-400">
            <p className="flex items-center justify-center gap-1 text-emerald-400 font-semibold">
              ...
              Verified Lifetime License (4K Lockscreen + 15-Min Solfeggio Audio Suite)
            </p>
            <p>
              Listen to the 15-minute master audio files while viewing your daily lockscreen wallpaper to align your attention filter (RAS).
            </p>
          </div>
        </div>
